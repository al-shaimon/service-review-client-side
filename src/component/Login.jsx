    ...
    <div className="hero  my-20 container mx-auto">
      <div className="hero-content grid md:gap-20 md:grid-cols-2 flex-col lg:flex-row">
        <div className="text-center lg:text-left">
          <img
            className="md:w-2/3 inline md:block"
            src="https://upload.wikimedia.org/wikipedia/en/4/44/Aperture_Icon.png"
            alt="logo"
          />
          <p className="font-[Lato] font-bold text-3xl text-center">
            Hi please login to explore and add services.
            <br /> Have fun.
          </p>
        </div>
        <div className="card sm:contents md:flex flex-shrink-0 w-full max-w-sm shadow-2xl bg-base-100 py-20">
                ...
                <div className="modal" id="my-modal-2">
                  <div className="modal-box">
                    ...
                    <div className="modal-action">
                      <a href="#" className="btn" onClick={resetPass}>
                        Reset Password
                      </a>
                    </div>
                  </div>
          ...
          <button className="btn btn-ghost w-1/2 mx-auto mt-2" onClick={handleGoogleLogin}>
